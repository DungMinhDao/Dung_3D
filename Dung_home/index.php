        ...
        <div class="hero-slider__container-area">
            <div class="swiper-container hero-slider__container">
                <div class="swiper-wrapper hero-slider__wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="hero-slider__content">
                                            <h2 class="hero-slider__title">HỘP CỨNG TÂN PHÁT</h2>
                                            <p class="hero-slider__text">Hộp cứng Tân Phát - Chất lượng sản phẩm tạo nên thương hiệu</p>
                    ...
                    <div class="swiper-slide hero-slider__single-item bg-img" data-bg="assets/img/slider/slider6.jpg">
                        <div class="hero-slider__content-wrapper">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="hero-slider__content">
                                            <h2 class="hero-slider__title">IN HỘP CỨNG CAO CẤP</h2>
                                            <p class="hero-slider__text">IN VÀ SẢN XUẤT BAO BÌ TÂN PHÁT với việc ngày càng tập trung phát triển kỹ thuật và công nghệ in ấn giấy bồi, carton, giấy mỹ thuật đã và đang sản xuất ra được những sản phẩm hộp cứng cao cấp đựng quà tặng theo mọi nhu cầu của khách hàng.</p>
                                            <a class="hero-slider__btn" href="contact.html"> GET START</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="hero-slider__content-wrapper">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="hero-slider__content">
                                            <h2 class="hero-slider__title">HỘP QUÀ TẶNG</h2>
                                            <p class="hero-slider__text">In hộp quà tặng cao cấp là một trong những cách marketing hiệu quả nhất. Nắm bắt được điều này, IN VÀ SẢN XUẤT BAO BÌ TÂN PHÁT đã cho ra đời dịch vụ in ấn hộp quà cao cấp, giá rẻ phù hợp với mọi yêu cầu của khách hàng.</p>
                                            <a class="hero-slider__btn" href="contact.html"> GET START</a>
                                        </div>
                                    </div>
                                </div>
